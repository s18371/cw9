    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            var res2 = Emps.Where(emp => emp.Job == "Backend programmer").Select(emp => emp);
        ...
        public void Przyklad5()
        {
            ...
            //2. lambda  extension
            var res2 = Emps.Select(a => new { Nazwisko = a.Ename, Praca = a.Job });
            Console.WriteLine("Lambda");
            foreach (var r in res2)
            {
                Console.WriteLine(r);
        ...
        /// <summary>
        /// SELECT Emps.Ename, Emps.Ename Depts.Dname FROM Emps
        ...
        public void Przyklad6()
        {
            ...
            //2. lambda  extension
            var res2 = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (Emps, Depts) => new
            {
                Emps.Ename,
                Emps.Job,
                Depts.Dname
        ...
        public void Przyklad8()
        {
            ...
            //nie da sie
            //2. lambda  extension
            var res2 = Emps.Any(emp => emp.Job.Equals("Backend programmer"));
            Console.WriteLine("Lambda");
            Console.WriteLine(res2);
